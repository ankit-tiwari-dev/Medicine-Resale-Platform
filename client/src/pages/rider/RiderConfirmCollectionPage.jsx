  ...
  return (
    <div className="min-h-screen bg-muted/30 pb-20">
      <Container className="py-8 lg:py-12 max-w-[800px]">
        {/* Header */}
        <div className="mb-10">
          <Link to="/rider/tasks" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors font-medium mb-6">
          ...
          <form onSubmit={onSubmit} className="space-y-8">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="space-y-4">
                  ...
                  {preview ? (
                    <>
                      ...
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                        <Button type="button" variant="outline" className="bg-white border-none h-10 px-4 rounded-xl font-bold flex gap-2">
                    ...
                    <>
                      <Camera className="text-muted-foreground mb-4 group-hover:scale-110 transition-transform" size={40} />
                ...
                <div className="flex gap-2 text-[10px] text-muted-foreground font-medium bg-muted/30 p-3 rounded-xl">
            ...
            <div className="pt-6 border-t border-border border-dashed flex items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                <AlertCircle size={20} className="text-muted-amber" />
