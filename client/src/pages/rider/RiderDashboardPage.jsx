    ...
    <div className="min-h-screen bg-muted/20 pb-20">
      <Container className="max-w-[1440px] mx-auto px-6 lg:px-8 py-8 animate-in fade-in duration-500">
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <span className="text-[10px] font-black uppercase tracking-widest">{data?.isActive ? "OFF" : "ON"}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, i) => (
            <div key={i} className="bg-surface rounded-[1.5rem] p-6 shadow-sm border border-border hover:border-primary/20 transition-all group">
              <div className="flex items-center justify-between mb-4">
                <div className="w-10 h-10 bg-foreground text-background rounded-xl flex items-center justify-center font-black text-[10px] tracking-tighter">
                  {stat.type}
                </div>
              </div>
              <div className="text-2xl font-black text-foreground mb-1 font-serif">{stat.value}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="bg-card rounded-[2rem] p-8 shadow-md border border-border">
              ...
              {loading ? (
                ...
                <div className="py-20 text-center bg-muted/5 rounded-[2rem] border-2 border-dashed border-border/50">
                  <div className="w-16 h-16 bg-muted/20 rounded-full flex items-center justify-center mx-auto mb-6 font-black text-[10px] text-muted-foreground opacity-30 uppercase tracking-widest">
                    NULL
                  </div>
            ...
            <div className="bg-clinical-navy rounded-[2.5rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-clinical-navy/20">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md font-black text-[10px] text-primary">
                    SECURE
                  </div>
                  <div>
          ...
          <div className="space-y-6">
            ...
            {/* Payout Notification */}
            <div className="bg-foreground rounded-[2rem] p-8 text-background shadow-2xl relative overflow-hidden group">
              <div className="relative z-10 flex gap-5">
                <div className="w-12 h-12 bg-background text-foreground rounded-xl flex items-center justify-center font-black text-[10px] shrink-0">
                  PAY
                </div>
                <div>
